...
public class SeriesConfiguration : IEntityTypeConfiguration<Series>
{
    public void Configure(EntityTypeBuilder<Series> b)
    {
        ...
        // Case-insensitive name using Postgres CITEXT (requires citext extension; see DbContext)
        b.Property(x => x.Name)
         .HasMaxLength(200)
        ...
        // Case-insensitive unique index across (season_year, name)
        b.HasIndex(x => new { x.SeasonYear, x.Name })
         .IsUnique()
